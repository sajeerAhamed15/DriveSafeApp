        ...
        mHandler = new Handler(){
            public void handleMessage(android.os.Message msg){
                if(msg.what == MESSAGE_READ){
                    ...
                    //0= alert and 1 = noraml
                    if(isAlert[0]==false && readMessage.contains("0")){
                        isAlert[0] =true;

                        // need an alert
                        mStatus.setText("ALERT");
                        mStatus.setVisibility(View.VISIBLE);
                        mStatus.setBackgroundColor(getResources().getColor(R.color.red));
                        sendNotification("ALERT!!!");


                    }else if (isAlert[0]==true && readMessage.contains("1")){
                        isAlert[0]=false;

                        //need a green
                        mStatus.setText("SAFE");
                        mStatus.setVisibility(View.VISIBLE);
                        mStatus.setBackgroundColor(getResources().getColor(R.color.green));
                    }
